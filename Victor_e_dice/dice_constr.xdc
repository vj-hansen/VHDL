...
## Switches
#########################################################################
set_property PACKAGE_PIN V17 [get_ports {set_val[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {set_val[0]}]
set_property PACKAGE_PIN V16 [get_ports {set_val[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {set_val[1]}]
set_property PACKAGE_PIN W16 [get_ports {set_val[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {set_val[2]}]
#########################################################################
...
#set_property PACKAGE_PIN U1 [get_ports {set_val[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {set_val[2]}]
#set_property PACKAGE_PIN T1 [get_ports {set_val[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {set_val[1]}]

#########################################################################
set_property PACKAGE_PIN R2 [get_ports {cheat}]					
